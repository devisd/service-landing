...
export const SearchPlusIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
    <svg className={className} width={size} height={size} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ClipboardCheckIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
    <svg className={className} width={size} height={size} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// Logo - simplified devices (laptop, phone, tablet)
export const DevicesIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
        {/* Laptop */}
        <path d="M4 6a2 2 0 012-2h8a2 2 0 012 2v6H4V6z" fillOpacity="0.8"/>
        <path d="M2 14h12v1a1 1 0 01-1 1H3a1 1 0 01-1-1v-1z"/>
        {/* Phone */}
        <path d="M17 8a1 1 0 011-1h3a1 1 0 011 1v12a1 1 0 01-1 1h-3a1 1 0 01-1-1V8z" fillOpacity="0.9"/>
        <circle cx="19.5" cy="18" r="0.5"/>
        {/* Tablet */}
        <path d="M14 17a1 1 0 011-1h3v5h-3a1 1 0 01-1-1v-3z" fillOpacity="0.7"/>
    </svg>
);
